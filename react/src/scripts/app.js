...
var SmartButton = React.createClass({displayName: 'SmartButton',
    propTypes: {
    ...
    render: function() {
        ...
        return (
            React.createElement("a", {className: classes, disabled:  this.state.activated, onClick:  this.trigger},  this.state.buttonLabel)
        );
    }
});
...
},{"./components/SmartButton":149,"react":"nakDgH"}]},{},[150])